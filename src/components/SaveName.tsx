    ...
    return (
        <div className="mt-[90%] lg:mt-[20%] flex flex-col justify-center items-centers">
            <div className={`flex items-center border-b py-2 px-2 ${error?"border-red-500":"border-teal-500"} `}>
                <input value={playerName} onChange={handleOnChange} className="appearance-none bg-transparent border-none w-full text-white-700 text-xl mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="Jane Doe" aria-label="Full name" required />           
